const CACHE='vestaland-v5';
const CORE=['/','/index.html','/styles.css','/desktop-enhancements.css','/assets/redesign-v3.css','/app.js','/assets/native.js','/manifest.webmanifest','/icon.svg'];
